...
def parse_args():
    ...
    parser.add_argument('--deep_supervision', type=bool, default=True, help='True or False (model==DNANet)')
    parser.add_argument('--seed', type=int, default=42)

    # data and pre-process
    parser.add_argument('--dataset', type=str, default='UAV_dataset',
                        help='dataset name: UAV_dataset,NUDT-SIRST, NUAA-SIRST, NUST-SIRST')
