...
def parse_args():
    ...
    parser.add_argument('--dataset', type=str, default='UAV_dataset',
                        help='dataset name: NUDT-SIRST, NUAA-SIRST, NUST-SIRST')
    parser.add_argument('--st_model', type=str, default='UAV_dataset_DNANet_24_05_2023_10_56_46_wDS',
                        help='NUDT-SIRST_DNANet_31_07_2021_14_50_57_wDS,'
                             'NUAA-SIRST_DNANet_28_07_2021_05_21_33_wDS')
    parser.add_argument('--model_dir', type=str,
                        default = 'UAV_dataset_DNANet_24_05_2023_10_56_46_wDS/mIoU__DNANet_UAV_dataset_epoch.pth.tar',
