...
class TrainSetLoader(Dataset):
    ...
    def __init__(self, dataset_dir, img_id ,base_size=512,crop_size=480,transform=None,suffix='.jpg'):
        super(TrainSetLoader, self).__init__()

        self.transform = transform
        self._items = img_id
        self.masks = dataset_dir+'/mask/train_val'
        self.images = dataset_dir+'/train'
...
def save_model(mean_IOU, best_iou, save_dir, save_prefix, train_loss, test_loss, recall, precision, epoch, net):
    if mean_IOU > best_iou:
        ...
        save_ckpt({
            ...
            filename='mIoU_' + '_' + save_prefix + '_epoch_' +str(mean_IOU)[2:6] + '.pth.tar')
